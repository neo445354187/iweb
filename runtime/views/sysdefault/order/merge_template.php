...
<body>
	...
	<table class="table" width="100%" cellspacing="0" cellpadding="0" border="1">
		...
		<tbody>
			...
			<?php $query = new IQuery("order_goods");$query->where = "order_id = $id";$items = $query->find(); foreach($items as $key => $item){?>
			...
			<tr>
				...
				<td><?php echo isset($item['goods_weight'])?$item['goods_weight']:"";?>g</td>
	...
	<table class="table f14" width="100%" cellspacing="0" cellpadding="0" border="0">
		<tr>
			<td align="right">商品总价：￥<?php echo isset($payable_amount)?$payable_amount:"";?></td>
		</tr>
		<tr>
			<td align="right">订单优惠：￥<?php echo $promotions+$discount;?></td>
		</tr>
		<tr>
			<td align="right">运费价格：￥<?php echo isset($real_freight)?$real_freight:"";?></td>
		</tr>
		<tr>
			<td align="right">订单价格：￥<?php echo isset($order_amount)?$order_amount:"";?></td>
		</tr>
		<tr>
...
<div class="container">
	...
	<table class="table" width="100%" cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td align="left">订单备注：<?php echo isset($note)?$note:"";?></td>
		</tr>
	</table>
